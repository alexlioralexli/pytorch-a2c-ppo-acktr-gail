...
for env in envs:
    commands = []
    base_command = f'python main.py --env-name {env} --algo ppo --use-gae --log-interval 1 --num-steps 2048 --num-processes 1 --lr 2.5e-4 --entropy-coef 0.001 --ppo-epoch 10 --num-mini-batch 32 --gamma 0.99 --gae-lambda 0.95 --use-proper-time-limits'
    for n_hidden in [1,2]:
